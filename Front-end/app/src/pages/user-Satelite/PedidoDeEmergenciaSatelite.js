...
export default function PedidoDeEmergenciaSatelite(){
    ...
    const [hospital_solicitante, setHospitalSolicitante] = useState("");
    ...
    return(
        <Container sx={{ display: "flex", minWidth: "100%", padding: "20px"}}disableGutters>
            ...
            <Box style={boxShadowStyle}>
                <Typography variant="h5" component="div" sx={{ paddingBottom: "25px", paddingTop: "10px" }}>
                ...
                <Grid container spacing={2} columns={4}>
                    <Grid item xs={2}>
                        <FormControl sx={{ minWidth: "100%" }} variant="outlined">
                            <Select
                                onChange={(v) => setHospitalSolicitante(v.target.value)}
                                value={hospital_solicitante}
                                sx={{ width: "100%" }}
                                displayEmpty
                            >
                                <MenuItem value="" default disabled>
                                <em>Hospital solicitante *</em>
                                </MenuItem>
            ...
            >
                ...
                <Typography variant="p" component="p" sx={{ marginBottom: "5px" }}>
                    Hospital solicitante: {hospital_solicitante}
                </Typography>
                <Typography variant="p" component="p" sx={{ marginBottom: "5px" }}>
